...
namespace Ch8DemosSortedLists {

    internal class Program {

        private static void Main(string[] args) {
            MyConsole.PrintLine("Welcome to the Ch 8 Demos - Sorted Lists!");
            // pg 262
            // created SortedList of usStates
            ...
            // pg 263 collection intializer
            //usStates=new SortedList<string,string> { { "OH","Ohio" },{ "IN","Indiana" },{ "CO","Colorado" },{ "MI","Michigan" },{ "AL","Alabama" },{ "HI","Hawaii" } };
            // using chatgpt
            usStates=new SortedList<string,string> {
                ...
                { "NH", "NewHampshire" }, { "NJ", "NewJersey" },
                { "NM", "NewMexico" }, { "NY", "NewYork" },
                { "NC", "NorthCarolina" }, { "ND", "NorthDakota" },
                { "OH", "Ohio" }, { "OK", "Oklahoma" },
                { "OR", "Oregon" }, { "PA", "Pennsylvania" },
                { "RI", "RhodeIsland" }, { "SC", "SouthCarolina" },
                { "SD", "SouthDakota" }, { "TN", "Tennessee" },
                { "TX", "Texas" }, { "UT", "Utah" },
                { "VT", "Vermont" }, { "VA", "Virginia" },
                { "WA", "Washington" }, { "WV", "WestVirginia" },
            ...
            string sa = "";
            while (sa!="EX") {
                sa=MyConsole.PromptString("Enter State Abbrev: ").ToUpper();
                if (sa=="EX") break;
                string sn = "";
                try {
                    sn=usStates[sa];
